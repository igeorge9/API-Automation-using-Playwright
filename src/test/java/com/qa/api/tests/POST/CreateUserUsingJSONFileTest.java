...
//        POST call : Create a user
        APIResponse apiPostCallResponse = requestContext.post("https://gorest.co.in/public/v2/users", RequestOptions.create().setHeader("Content-type", "Application/json").setHeader("Authorization", "Bearer 38d20a9503c4e6502c70d9154ae2e7e4e5654bdd4d1a9a38dd5275b87adaa11c").setData(fileInBytes));
        ...
        JsonNode postJSONResponse = mapper.readTree(apiPostCallResponse.body());
