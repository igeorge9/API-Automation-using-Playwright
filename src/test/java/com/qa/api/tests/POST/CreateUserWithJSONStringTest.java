...
//        POST call : Create a user
        ...
        Assert.assertTrue(apiPostCallResponse.ok());
        Assert.assertEquals(apiPostCallResponse.statusText(), "Created");
        System.out.println("Status code : " + apiPostCallResponse.status());
        System.out.println("Status text : " + apiPostCallResponse.statusText());
